...
export function generateDiffMarkdown(diff: SnapshotDiff, guildName: string): string {
  ...
  md += `\n---\n\n## See Also\n\n`;
  md += `- [ROLES.md](ROLES.md) — full role permission matrix and staff/bot role details\n`;
  md += `- [CHANNELS.md](CHANNELS.md) — channel hierarchy and permission overwrites\n`;
  md += `- [CONFLICTS.md](CONFLICTS.md) — security issues found by \`/audit security\`\n`;
  md += `- [HIERARCHY.md](HIERARCHY.md) — top-to-bottom role position list\n`;
  md += `- [SERVER-INFO.md](SERVER-INFO.md) — server settings and aggregate statistics\n`;
  md += `- [/audit security command flow](../audit-security-flow.md) — how this file is generated\n`;
  md += `- [Audits index](../audits/README.md) — broader audit and security documentation\n`;
  md += `- [Leadership Guide](../LEADERSHIP-GUIDE.md) — the role tier that runs \`/audit security\`\n`;
