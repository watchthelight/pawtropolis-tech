...
export function generateMarkdownReport(data: ReportData): string {
  ...
  lines.push(
    ...
    `- [Code Audit 2026](CODE-AUDIT-2026.md) — current code audit findings backlog`,
    `- [/audit security flow](../audit-security-flow.md) — sister audit that covers role/channel security`,
