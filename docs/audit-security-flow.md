...
| File | Contents |
|------|----------|
| [`internal-info/ROLES.md`](internal-info/ROLES.md) | Role hierarchy, permission matrix, staff/bot role details |
| [`internal-info/CHANNELS.md`](internal-info/CHANNELS.md) | Channel hierarchy, permission overwrites per channel |
| [`internal-info/CONFLICTS.md`](internal-info/CONFLICTS.md) | All security issues found, sorted by severity |
| [`internal-info/SERVER-INFO.md`](internal-info/SERVER-INFO.md) | Server settings, statistics, feature flags |
| [`internal-info/HIERARCHY.md`](internal-info/HIERARCHY.md) | Full top-to-bottom role hierarchy |
| [`internal-info/DIFF.md`](internal-info/DIFF.md) | Permission diff since the previous run |

> All files in `docs/internal-info/` are auto-generated by this command. Don't hand-edit them — your changes will be overwritten on the next run.

---

## See Also

- [Audits](audits/README.md) — index of audit reports and historical security analyses
- [Leadership Guide](LEADERSHIP-GUIDE.md) — the role-tier docs for the people who run `/audit security`
- [Permissions Matrix](PERMS-MATRIX.md) — the source of truth for who is supposed to have what
- [Bot Handbook — `/audit`](BOT-HANDBOOK.md#audit) — user-facing command details
