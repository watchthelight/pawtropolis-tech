...
|:----:|------|---------|:------------:|
| 1 | ![@Community Founder](https://raw.githubusercontent.com/watchthelight/pawtropolis-tech/main/docs/badges/svg/role-community-founder.svg?v=16335ab2) | `896070888779317254` | CF |
| 2 | ![@Community Manager](https://raw.githubusercontent.com/watchthelight/pawtropolis-tech/main/docs/badges/svg/role-community-manager.svg?v=3d0ff81a) | `1190093021170114680` | CM |
| 3 | ![@Community Development Lead](https://raw.githubusercontent.com/watchthelight/pawtropolis-tech/main/docs/badges/svg/role-community-dev-lead.svg?v=f6b6a801) | `1382242769468260352` | CDL |
| 4 | ![@Senior Administrator](https://raw.githubusercontent.com/watchthelight/pawtropolis-tech/main/docs/badges/svg/role-senior-admin.svg?v=7e274151) | `1420440472169746623` | SA |
| 5 | ![@Administrator](https://raw.githubusercontent.com/watchthelight/pawtropolis-tech/main/docs/badges/svg/role-administrator.svg?v=1c282267) | `896070888779317248` | A |
| 6 | ![@Senior Moderator](https://raw.githubusercontent.com/watchthelight/pawtropolis-tech/main/docs/badges/svg/role-senior-mod.svg?v=e3f969b6) | `1095757038899953774` | SM |
| 7 | ![@Moderator](https://raw.githubusercontent.com/watchthelight/pawtropolis-tech/main/docs/badges/svg/role-moderator.svg?v=a7851845) | `896070888762535975` | M |
| 8 | ![@Junior Moderator](https://raw.githubusercontent.com/watchthelight/pawtropolis-tech/main/docs/badges/svg/role-junior-mod.svg?v=959ede3d) | `896070888762535966` | JM |
| 9 | ![@Gatekeeper](https://raw.githubusercontent.com/watchthelight/pawtropolis-tech/main/docs/badges/svg/role-gatekeeper.svg?v=10e9a595) | `896070888762535969` | GK |
| 10 | ![@Community Staff](https://raw.githubusercontent.com/watchthelight/pawtropolis-tech/main/docs/badges/svg/role-community-staff.svg?v=86013337) | `987662057069482024` | CS |
...
| Role | ID | Notes |
|------|-----|-------|
| ![@Server Dev](https://raw.githubusercontent.com/watchthelight/pawtropolis-tech/main/docs/badges/svg/role-server-dev.svg?v=eba7d6c0) | `1120074045883420753` | Staff role with full access |
...
| Role | ID | Access |
|------|----|--------|
| ![@Event Host](https://raw.githubusercontent.com/watchthelight/pawtropolis-tech/main/docs/badges/svg/role-event-host.svg?v=1274c550) | `1243805450835853383` | `/event movie`, `/event game` |
| ![@Events Manager](https://raw.githubusercontent.com/watchthelight/pawtropolis-tech/main/docs/badges/svg/role-events-manager.svg?v=9e9be662) | `1243805681904259124` | `/event movie`, `/event game` |
