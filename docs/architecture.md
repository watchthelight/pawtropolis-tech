...
- Curated database reference: [docs/reference/database-schema.md](./reference/database-schema.md)
- Deployment and runtime config: [docs/operations/deployment-config.md](./operations/deployment-config.md)
- Troubleshooting: [docs/operations/troubleshooting.md](./operations/troubleshooting.md)
- Bot Handbook (user-facing): [docs/BOT-HANDBOOK.md](./BOT-HANDBOOK.md)
