...
```markdown
![@Director's Cut](https://raw.githubusercontent.com/watchthelight/pawtropolis-tech/main/docs/badges/svg/movie-tier-3.svg?v=226fda98)
```
...
```markdown
[![#「✍️」writing](https://raw.githubusercontent.com/watchthelight/pawtropolis-tech/main/docs/badges/svg/channel-writing.svg?v=a9387be4)](https://discord.com/channels/<GUILD_ID>/<CHANNEL_ID>)
```
