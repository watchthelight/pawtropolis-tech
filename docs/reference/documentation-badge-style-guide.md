...
```markdown
![@Director's Cut](https://cdn.jsdelivr.net/gh/watchthelight/pawtropolis-tech@main/docs/badges/svg/movie-tier-3.svg)
```
...
```markdown
[![#「✍️」writing](https://cdn.jsdelivr.net/gh/watchthelight/pawtropolis-tech@main/docs/badges/svg/channel-writing.svg)](https://discord.com/channels/<GUILD_ID>/<CHANNEL_ID>)
```
