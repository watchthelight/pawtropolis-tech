...
```markdown
![@Director's Cut](https://raw.githubusercontent.com/watchthelight/pawtropolis-tech/main/docs/badges/svg/movie-tier-3.svg?v=2dc09f33)
```
...
```markdown
[![#「✍️」writing](https://raw.githubusercontent.com/watchthelight/pawtropolis-tech/main/docs/badges/svg/channel-writing.svg?v=48b00c64)](https://discord.com/channels/<GUILD_ID>/<CHANNEL_ID>)
```
