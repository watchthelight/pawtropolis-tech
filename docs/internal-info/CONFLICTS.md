...
**Generated:** 2026-01-12T07:35:56.905Z
...
- **Affected:** Role: Enter Key (1429936065002602526)
...
- **Issue:** Lower-positioned role "Senior Administrator" has dangerous permissions that "Enter Key" lacks: BanMembers, KickMembers, ManageChannels, ManageGuild, ManageMessages, ManageRoles, ManageWebhooks, MentionEveryone, ModerateMembers
...
### [CRIT-006] Administrator Permission on User Role *(Acknowledged)*
...
*To unacknowledge, use `/audit unacknowledge CRIT-006`*
...
### [MED-053] Webhook Access to Sensitive Channels *(Acknowledged)*
