...
- [Code Audit 2026](CODE-AUDIT-2026.md) — newer code audit (the K1-K5 pre-checks reference this audit)
...
- [Permissions Matrix](../PERMS-MATRIX.md) — source of truth for expected permissions
