...
check('owner can permreject without admin tier explicit', canPerformReviewAction('owner', [OTHER], 'permreject'), true);
...
check('REGRESSION: Junior Mod without GK cannot claim', canPerformReviewAction('jm', [OTHER], 'claim'), false);
check('REGRESSION: Junior Mod without GK cannot approve', canPerformReviewAction('jm', [OTHER], 'approve'), false);
check('REGRESSION: Junior Mod without GK cannot reject', canPerformReviewAction('jm', [OTHER], 'reject'), false);
check('REGRESSION: Junior Mod without GK cannot kick', canPerformReviewAction('jm', [OTHER], 'kick'), false);
check('REGRESSION: Junior Mod without GK cannot wrong_password', canPerformReviewAction('jm', [OTHER], 'wrong_password'), false);
check('REGRESSION: Junior Mod without GK cannot vote_out', canPerformReviewAction('jm', [OTHER], 'vote_out'), false);
check('REGRESSION: Moderator without GK cannot claim', canPerformReviewAction('mod', [OTHER], 'claim'), false);
check('REGRESSION: Senior Mod without GK cannot reject', canPerformReviewAction('sm', [OTHER], 'reject'), false);
...
check('Admin without GK can unclaim (override)', canPerformReviewAction('admin', [OTHER], 'unclaim'), true);
check('Senior Admin without GK can unclaim', canPerformReviewAction('sa', [OTHER], 'unclaim'), true);
check('Junior Mod without GK CANNOT unclaim', canPerformReviewAction('jm', [OTHER], 'unclaim'), false);

// permreject: admin tier required, GK role not sufficient on its own
check('Admin without GK can permreject', canPerformReviewAction('admin', [OTHER], 'permreject'), true);
...
check('GK without admin tier CANNOT permreject', canPerformReviewAction('gk', [GK], 'permreject'), false);
...
check('Viewer with GK role can claim (role wins)', canPerformReviewAction('viewer', [OTHER, GK], 'claim'), true);
