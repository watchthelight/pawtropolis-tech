...
type ValueType = 'channel' | 'role' | 'roles' | 'bool' | 'ms' | 'seconds' | 'minutes' | 'hours' | 'chars' | 'number' | 'percent' | 'json' | 'text' | 'template';
...
const FIELD_META: Record<string, { section: string } & FieldMeta> = {
	...
	backfill_notification_channel_id: { section: 'Channels', label: 'Backfill Notification Channel', type: 'channel' },
	server_artist_channel_id: { section: 'Channels', label: 'Server Artist Channel', type: 'channel' },
	...
	avatar_scan_nsfw_threshold: { section: 'Avatar Scanning', label: 'NSFW Threshold', type: 'percent' },
	avatar_scan_skin_edge_threshold: { section: 'Avatar Scanning', label: 'Skin Edge Threshold', type: 'percent' },
	...
	avatar_scan_hard_threshold: { section: 'Avatar Scanning', label: 'Hard Threshold', type: 'percent' },
	avatar_scan_soft_threshold: { section: 'Avatar Scanning', label: 'Soft Threshold', type: 'percent' },
	avatar_scan_racy_threshold: { section: 'Avatar Scanning', label: 'Racy Threshold', type: 'percent' },
	...
	circuit_breaker_threshold: { section: 'Advanced', label: 'Circuit Breaker Threshold', type: 'number' },
	...
	banner_sync_interval_minutes: { section: 'Advanced', label: 'Banner Sync Interval', type: 'minutes' },
	...
	poke_excluded_channel_ids_json: { section: 'Advanced', label: 'Poke Excluded Channels', type: 'json' },
...
const HIDDEN_COLUMNS = new Set([
	'guild_id', 'id', 'updated_at_s', 'panic_enabled_at', 'panic_enabled_by',
	'welcome' // JSON blob handled separately by the bot
]);

// Desired section order
const SECTION_ORDER = [
	'Channels', 'Roles', 'Gate', 'Avatar Scanning', 'Notifications',
	'Artist', 'Modmail', 'Fun Modes', 'Panic Mode', 'Templates', 'Advanced', 'Other'
];
