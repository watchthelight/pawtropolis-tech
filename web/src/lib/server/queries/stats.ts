...
export function getPersonalStatsTrend(
	...
	// Previous period response times
	const prevClaimToDecision = getClaimToDecisionAvg(userId, guildId, previousFrom);
	const prevSubmitToClaim = getSubmitToFirstClaimAvg(guildId, previousFrom);
