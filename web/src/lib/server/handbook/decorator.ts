...
import { meetsTier, parsePermissionLine, stripWhoCanUseItPrefix, type HandbookTier, type PermissionRequirement } from './permissionResolver';
 ...
 */
export function decorate(tokens: Token[], meta: DocMeta, viewerTier: HandbookTier, isLoggedOut: boolean): DecoratedDoc {
	...
	while (i < tokens.length) {
		...
		tocEntries.push({ depth: heading.depth, slug, text: headingPlain || headingText, tier: requiredTier });
