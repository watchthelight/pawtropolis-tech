...
<style>
	...
	/* Discord button — magnetic tilt via JS, glow via CSS */
	.discord-btn {
		position: relative;
		display: inline-flex;
		align-items: center;
		...
		box-shadow:
			0 4px 20px oklch(65% 0.2 330 / 0.3),
			inset 0 1px 0 oklch(90% 0.05 200 / 0.15);
	}

	.discord-btn:hover {
		box-shadow:
			0 8px 40px oklch(65% 0.25 330 / 0.45),
			0 0 30px oklch(70% 0.2 200 / 0.2),
			inset 0 1px 0 oklch(90% 0.05 200 / 0.2);
	}
